...
#ifndef AI_CAN_NETWORK_H
#define AI_CAN_NETWORK_H
#pragma once
...
/******************************************************************************/
#define AI_CAN_NETWORK_MODEL_NAME          "can_network"
#define AI_CAN_NETWORK_ORIGIN_MODEL_NAME   "tfmodel_final"

/******************************************************************************/
#define AI_CAN_NETWORK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CAN_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CAN_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CAN_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_CAN_NETWORK_IN \
  ai_can_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CAN_NETWORK_IN_SIZE { \
  AI_CAN_NETWORK_IN_1_SIZE, \
}
#define AI_CAN_NETWORK_IN_SIZE_BYTES { \
  AI_CAN_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_CAN_NETWORK_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_CAN_NETWORK_IN_1_HEIGHT      (9)
#define AI_CAN_NETWORK_IN_1_WIDTH       (1)
#define AI_CAN_NETWORK_IN_1_CHANNEL     (1)
#define AI_CAN_NETWORK_IN_1_SIZE        (9 * 1 * 1)
#define AI_CAN_NETWORK_IN_1_SIZE_BYTES  (36)

/******************************************************************************/
#define AI_CAN_NETWORK_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CAN_NETWORK_OUT \
  ai_can_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CAN_NETWORK_OUT_SIZE { \
  AI_CAN_NETWORK_OUT_1_SIZE, \
}
#define AI_CAN_NETWORK_OUT_SIZE_BYTES { \
  AI_CAN_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_CAN_NETWORK_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_CAN_NETWORK_OUT_1_CHANNEL     (2)
#define AI_CAN_NETWORK_OUT_1_SIZE        (2)
#define AI_CAN_NETWORK_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_CAN_NETWORK_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup can_network
 ...
 * @ref ai_can_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_can_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_can_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_can_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CAN_NETWORK_*
 * defines into file @ref can_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_can_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_CAN_NETWORK_H */
