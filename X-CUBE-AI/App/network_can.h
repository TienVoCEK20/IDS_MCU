...
#ifndef AI_NETWORK_CAN_H
#define AI_NETWORK_CAN_H
#pragma once

#include "network_can_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_CAN_MODEL_NAME          "network_can"
#define AI_NETWORK_CAN_ORIGIN_MODEL_NAME   "tfmodel_final"

/******************************************************************************/
#define AI_NETWORK_CAN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_CAN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_CAN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_CAN_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_CAN_IN \
  ai_network_can_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_CAN_IN_SIZE { \
  AI_NETWORK_CAN_IN_1_SIZE, \
}
#define AI_NETWORK_CAN_IN_SIZE_BYTES { \
  AI_NETWORK_CAN_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_CAN_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_CAN_IN_1_HEIGHT      (9)
#define AI_NETWORK_CAN_IN_1_WIDTH       (1)
#define AI_NETWORK_CAN_IN_1_CHANNEL     (1)
#define AI_NETWORK_CAN_IN_1_SIZE        (9 * 1 * 1)
#define AI_NETWORK_CAN_IN_1_SIZE_BYTES  (36)

/******************************************************************************/
#define AI_NETWORK_CAN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_CAN_OUT \
  ai_network_can_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_CAN_OUT_SIZE { \
  AI_NETWORK_CAN_OUT_1_SIZE, \
}
#define AI_NETWORK_CAN_OUT_SIZE_BYTES { \
  AI_NETWORK_CAN_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_CAN_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_CAN_OUT_1_CHANNEL     (2)
#define AI_NETWORK_CAN_OUT_1_SIZE        (2)
#define AI_NETWORK_CAN_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_NETWORK_CAN_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_can
 ...
 * @ref ai_network_can_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_can_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_can_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_can_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_CAN_*
 * defines into file @ref network_can.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_can_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_CAN_H */
